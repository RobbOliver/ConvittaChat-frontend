...
function SendIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className="h-[18px] w-[18px] translate-x-[1px]" aria-hidden>
      <path d="M3 10 16.5 3.5 12 10l4.5 6.5L3 10Z" />
    </svg>
  );
}
